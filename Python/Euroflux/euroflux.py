...
### Plot differences between co2 directionality dependencies between chamau and neustift
...
for i in nights:
    mult = 48[i] - 7
    yee = (map(operator.add, mult, setb))
    ch_ind = np.where((dtime == sety) & (dtime == yee))
